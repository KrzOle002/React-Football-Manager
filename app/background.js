(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("electron-serve"), require("electron-store"), require("sequelize"));
	else if(typeof define === 'function' && define.amd)
		define(["electron-serve", "electron-store", "sequelize"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("electron-serve"), require("electron-store"), require("sequelize")) : factory(root["electron-serve"], root["electron-store"], root["sequelize"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, (__WEBPACK_EXTERNAL_MODULE_electron_serve__, __WEBPACK_EXTERNAL_MODULE_electron_store__, __WEBPACK_EXTERNAL_MODULE_sequelize__) => {
...
const createWindow = (windowName, options) => {
  ...
  const win = new electron__WEBPACK_IMPORTED_MODULE_11__.BrowserWindow(_objectSpread(_objectSpread(_objectSpread({}, state), options), {}, {
    ...
    //Usuwanie paska opcji przeglądarki
...
/* harmony import */ var _models_playerModel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/playerModel */ "./main/models/playerModel.ts");




// Tworzenie nowego piłkarza
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('player:create', async (_event, playerData) => {
  const player = await _models_playerModel__WEBPACK_IMPORTED_MODULE_2__.Player.create(playerData);
  return player;
});

// Pobieranie listy piłkarzy z paginacją i filtrowaniem
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('player:list', async (_event, {
  page = 1,
  pageSize = 10,
  filters = {}
}) => {
  ...
  const {
    rows,
    count
  } = await _models_playerModel__WEBPACK_IMPORTED_MODULE_2__.Player.findAndCountAll({
    where,
    offset,
    limit: pageSize,
  ...
  const players = _babel_runtime_corejs3_core_js_stable_instance_map__WEBPACK_IMPORTED_MODULE_0___default()(rows).call(rows, player => player.toJSON());
  return {
    players,
    total: count
  };
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('player:get', async (_event, id) => {
  const player = await _models_playerModel__WEBPACK_IMPORTED_MODULE_2__.Player.findByPk(id);
  return player || {
...
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('player:update', async (event, {
  playerId,
  updatedPlayer
}) => {
  try {
    const player = await _models_playerModel__WEBPACK_IMPORTED_MODULE_2__.Player.findByPk(playerId);
    if (!player) {
      return {
        success: false,
        error: 'Player not found'
      }; // Błąd, jeśli nie znaleziono zawodnika
    }
    ...
    }; // Błąd, jeśli wystąpił problem
  }
});

// Usuwanie piłkarza
electron__WEBPACK_IMPORTED_MODULE_1__.ipcMain.handle('player:delete', async (_event, id) => {
  const player = await _models_playerModel__WEBPACK_IMPORTED_MODULE_2__.Player.findByPk(id);
  if (!player) {
    return {
      error: 'Player not found'
...
/* harmony import */ var _database_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../database/index */ "./main/database/index.ts");



class Player extends sequelize__WEBPACK_IMPORTED_MODULE_1__.Model {
  constructor(...args) {
    super(...args);
    _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "id", void 0);
    _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "name", void 0);
    _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "position", void 0);
    _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "rating", void 0);
    _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "season", void 0);
    _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "createdAt", void 0);
    _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "updatedAt", void 0);
  }
}
Player.init({
  name: {
    type: sequelize__WEBPACK_IMPORTED_MODULE_1__.DataTypes.STRING,
    allowNull: false
  },
  position: {
    type: sequelize__WEBPACK_IMPORTED_MODULE_1__.DataTypes.STRING,
  ...
  sequelize: _database_index__WEBPACK_IMPORTED_MODULE_2__["default"],
  modelName: 'player',
  timestamps: true
});
...
/* harmony import */ var _database__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./database */ "./main/database/index.ts");
/* harmony import */ var _ipc_playerHandler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ipc/playerHandler */ "./main/ipc/playerHandler.ts");
...
(async () => {
  ...
  try {
    await _database__WEBPACK_IMPORTED_MODULE_4__["default"].sync(); // Synchronizacja modeli z bazą
